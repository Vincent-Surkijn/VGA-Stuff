...
#
# Generated by export_simulation on Fri Apr 24 16:12:03 +0200 2020
#
################################################################################
...
'-reset_run' switch to the './MovingSquare.sh' script.

./MovingSquare.sh -reset_run
...
./MovingSquare.sh -noclean_files

For more information on the script, please type './MovingSquare.sh -help'.
